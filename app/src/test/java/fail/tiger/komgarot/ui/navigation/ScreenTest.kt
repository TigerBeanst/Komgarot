...
class ScreenTest {
    ...
    fun seriesRouteEncodesSearchQuery() {
        val route = Screen.Series.go(id = null, search = "author:Author Name/Writer+Artist")

        assertEquals(
            "series/all?search=author%3AAuthor%20Name%2FWriter%2BArtist",
            route
        )
        assertEquals(
            "author:Author Name/Writer+Artist",
