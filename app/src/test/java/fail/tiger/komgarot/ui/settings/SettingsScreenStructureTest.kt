...
class SettingsScreenStructureTest {
    ...
    @Test
    fun serverUrlIsKeptOutOfSettingsCategories() {
        assertTrue(!source.contains("SettingsPage.SERVER"))
        assertTrue(!source.contains("Icons.Default.Dns"))
    }
    ...
    fun settingsContentIncludesAiTranslationOptions() {
        ...
        assertTrue(source.contains("prefs.aiSkipSoundEffects.collectAsStateWithLifecycle(initialValue = false)"))
        assertTrue(source.contains("prefs.setAiSkipSoundEffects"))
        assertTrue(source.contains("prefs.aiDisableModelThinking.collectAsStateWithLifecycle(initialValue = false)"))
        assertTrue(source.contains("prefs.setAiDisableModelThinking"))
        assertTrue(source.contains("R.string.settings_ai_disable_model_thinking"))
        assertTrue(source.contains("R.string.settings_ai_reasoning_effort"))
        assertTrue(source.contains("prefs.setAiReasoningEffort"))
        assertTrue(source.contains("R.string.settings_ai_additional_prompt"))
        assertTrue(source.contains("prefs.setAiCustomInstructions"))
        assertTrue(source.contains("singleLine = false"))
        assertTrue(source.contains("minLines = 4"))
        assertTrue(source.contains("maxLines = 12"))
